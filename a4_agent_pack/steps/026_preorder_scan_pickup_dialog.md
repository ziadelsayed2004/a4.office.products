...
# Step 026 — Preorder Scan Pickup Dialog
...
سكان الـ QR الخاص بالحجز يفتح Dialog فيه تفاصيل الأوردر والمتبقي والتسليم.
...
Write `agent_pack/reports/026_preorder_scan_pickup_dialog_REPORT.md` with all required report fields.
