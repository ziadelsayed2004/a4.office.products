...
شاشة POS سريعة: search/scan/cart/payment/print/shift summary.
...
Write `agent_pack/reports/042_cashier_pos_layout_REPORT.md` with all required report fields.
