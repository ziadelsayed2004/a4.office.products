...
# Step 060 — Final Acceptance Handoff
...
قبول نهائي، checklist، known gaps، وتسليم docs كاملة.
...
Write `agent_pack/reports/060_final_acceptance_handoff_REPORT.md` with all required report fields.
