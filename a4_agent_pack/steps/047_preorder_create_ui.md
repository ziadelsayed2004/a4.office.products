...
واجهة إنشاء الحجز، بيانات العميل الإجبارية، الديبوزت، والطباعة.
...
Write `agent_pack/reports/047_preorder_create_ui_REPORT.md` with all required report fields.
