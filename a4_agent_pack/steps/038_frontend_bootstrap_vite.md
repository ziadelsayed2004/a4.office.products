...
# Step 038 — Frontend Bootstrap Vite
...
تجهيز React/Vite، routing، auth context، API client، RTL Arabic first.
...
Write `agent_pack/reports/038_frontend_bootstrap_vite_REPORT.md` with all required report fields.
