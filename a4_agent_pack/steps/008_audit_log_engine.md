...
تسجيل كل العمليات المهمة: دخول، شيفت، بيع، حجز، تعديل مخزون، طباعة، تقفيل.
...
Write `agent_pack/reports/008_audit_log_engine_REPORT.md` with all required report fields.
