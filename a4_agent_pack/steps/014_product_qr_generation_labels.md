...
# Step 014 — Product QR Generation Labels
...
توليد QR آمن لكل منتج وطباعة ليبلز بأعداد ومقاسات مختلفة.
...
Write `agent_pack/reports/014_product_qr_generation_labels_REPORT.md` with all required report fields.
