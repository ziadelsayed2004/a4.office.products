...
# Step 029 — Shift Transaction Binding
...
ربط كل بيع/حجز/دفع/استلام/مرتجع بالشيفت والكاشير الحالي.
...
Write `agent_pack/reports/029_shift_transaction_binding_REPORT.md` with all required report fields.
