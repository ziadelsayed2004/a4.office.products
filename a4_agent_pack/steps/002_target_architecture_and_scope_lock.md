...
# Step 002 — Target Architecture And Scope Lock
...
تثبيت المعمارية النهائية والحدود الوظيفية للمنصة حسب PRD وقواعد العمل.
...
Write `agent_pack/reports/002_target_architecture_and_scope_lock_REPORT.md` with all required report fields.
