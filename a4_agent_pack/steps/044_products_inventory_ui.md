...
# Step 044 — Products Inventory UI
...
واجهات المنتجات والمخزون وعدد الحجوزات المفتوحة لكل منتج.
...
Write `agent_pack/reports/044_products_inventory_ui_REPORT.md` with all required report fields.
