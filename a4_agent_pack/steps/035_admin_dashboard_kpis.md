...
KPIs الأدمن: مبيعات، ديبوزت، محجوزات، مخزون منخفض، شيفتات معلقة، أفضل منتجات.
...
Write `agent_pack/reports/035_admin_dashboard_kpis_REPORT.md` with all required report fields.
