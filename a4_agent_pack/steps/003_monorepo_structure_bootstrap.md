...
# Step 003 — Monorepo Structure Bootstrap
...
تجهيز هيكلة المشروع: server Node/Express، client React/Vite، shared docs/config، وسكربتات التشغيل.
...
Write `agent_pack/reports/003_monorepo_structure_bootstrap_REPORT.md` with all required report fields.
