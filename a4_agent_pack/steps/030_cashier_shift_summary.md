...
# Step 030 — Cashier Shift Summary
...
الكاشير يرى ملخص شيفته فقط حسب طرق الدفع والتقارير المطلوبة للتقفيل.
...
Write `agent_pack/reports/030_cashier_shift_summary_REPORT.md` with all required report fields.
