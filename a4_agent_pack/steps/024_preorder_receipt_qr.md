...
ريسيت حجز يحتوي اسم/رقم العميل، الديبوزت، المتبقي، QR استلام آمن.
...
Write `agent_pack/reports/024_preorder_receipt_qr_REPORT.md` with all required report fields.
