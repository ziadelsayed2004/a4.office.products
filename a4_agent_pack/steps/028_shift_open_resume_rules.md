...
# Step 028 — Shift Open Resume Rules
...
فتح/استكمال شيفت للكاشير بالحساب فقط، بدون نقطة بيع، ومنع أكثر من شيفت نشط لنفس الكاشير.
...
Write `agent_pack/reports/028_shift_open_resume_rules_REPORT.md` with all required report fields.
