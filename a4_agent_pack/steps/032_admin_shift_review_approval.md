...
# Step 032 — Admin Shift Review Approval
...
الأدمن يراجع ويقبل/يرفض التقفيل مع فروقات وملاحظات.
...
Write `agent_pack/reports/032_admin_shift_review_approval_REPORT.md` with all required report fields.
