...
# Step 036 — Reports Filters Exports
...
تقارير بفلاتر وتصدير CSV/XLSX/PDF حسب البيع/الحجز/الشيفت/المخزون/الكاشير.
...
Write `agent_pack/reports/036_reports_filters_exports_REPORT.md` with all required report fields.
