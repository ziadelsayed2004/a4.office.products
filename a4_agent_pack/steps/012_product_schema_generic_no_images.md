...
# Step 012 — Product Schema Generic No Images
...
منتج عام بدون صور، يدعم كتب ومنتجات عادية وحقول كتب اختيارية.
...
Write `agent_pack/reports/012_product_schema_generic_no_images_REPORT.md` with all required report fields.
