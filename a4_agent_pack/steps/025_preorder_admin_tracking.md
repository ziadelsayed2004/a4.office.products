...
# Step 025 — Preorder Admin Tracking
...
إدارة المحجوزات وحالاتها وتقاريرها: Waiting Stock / Ready / Picked Up / Cancelled.
...
Write `agent_pack/reports/025_preorder_admin_tracking_REPORT.md` with all required report fields.
