...
# Step 041 — Admin Layout Navigation
...
Admin shell/sidebar/header، حماية الصفحات، breadcrumbs، responsive.
...
Write `agent_pack/reports/041_admin_layout_navigation_REPORT.md` with all required report fields.
