...
بيع مباشر مدفوع كلياً أو حسب قواعد الدفع، خصم من المخزون وطباعة ريسيت.
...
Write `agent_pack/reports/020_normal_sale_checkout_REPORT.md` with all required report fields.
