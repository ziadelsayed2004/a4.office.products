...
# Step 018 — Customers Minimal Module
...
تسجيل عملاء بسيط، وفي الحجز الاسم ورقم الموبايل إجباريين.
...
Write `agent_pack/reports/018_customers_minimal_module_REPORT.md` with all required report fields.
