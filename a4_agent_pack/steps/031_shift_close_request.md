...
الكاشير يدخل المبالغ الفعلية ويطلب قفل الشيفت، الحالة Pending Admin Review.
...
Write `agent_pack/reports/031_shift_close_request_REPORT.md` with all required report fields.
