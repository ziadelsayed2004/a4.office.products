...
تعليمات تشغيل محلي ورفع على Hostinger/VPS/Node حسب الاختيار.
...
Write `agent_pack/reports/059_deployment_docs_REPORT.md` with all required report fields.
