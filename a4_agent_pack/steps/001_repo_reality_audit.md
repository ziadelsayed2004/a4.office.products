...
اكتشاف حالة الريبو الحالية، تحديد هل المشروع جديد أو مبني على تيمبليت، وتوثيق الملفات الموجودة بدون تعديل جوهري.
...
Write `agent_pack/reports/001_repo_reality_audit_REPORT.md` with all required report fields.
