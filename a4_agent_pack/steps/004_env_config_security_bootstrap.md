...
# Step 004 — Env Config Security Bootstrap
...
إعداد ملفات البيئة، الأسرار، CORS، rate limits، timezone Africa/Cairo، وملفات .env.example.
...
Write `agent_pack/reports/004_env_config_security_bootstrap_REPORT.md` with all required report fields.
