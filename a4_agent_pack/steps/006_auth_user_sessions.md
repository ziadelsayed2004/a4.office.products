...
تنفيذ تسجيل دخول الأدمن والكاشير، JWT/refresh، logout، session tracking.
...
Write `agent_pack/reports/006_auth_user_sessions_REPORT.md` with all required report fields.
