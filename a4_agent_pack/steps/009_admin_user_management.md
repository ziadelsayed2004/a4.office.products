...
# Step 009 — Admin User Management
...
واجهات و APIs إنشاء/تعديل/تعطيل الكاشير وتغيير الباسورد من الأدمن فقط.
...
Write `agent_pack/reports/009_admin_user_management_REPORT.md` with all required report fields.
