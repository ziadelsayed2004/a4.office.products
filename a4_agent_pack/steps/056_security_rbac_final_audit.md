...
# Step 056 — Security RBAC Final Audit
...
مراجعة نهائية للصلاحيات، منع تسريب إيرادات الأدمن للكاشير.
...
Write `agent_pack/reports/056_security_rbac_final_audit_REPORT.md` with all required report fields.
