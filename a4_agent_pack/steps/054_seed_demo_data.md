...
بيانات تجربة: أدمن، كاشير، تصنيفات، فئات سعر، منتجات، طرق دفع.
...
Write `agent_pack/reports/054_seed_demo_data_REPORT.md` with all required report fields.
