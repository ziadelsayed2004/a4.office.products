...
Checkout بيع مباشر وطباعة ريسيت وربط بالشيفت.
...
Write `agent_pack/reports/046_normal_checkout_ui_REPORT.md` with all required report fields.
