# Step 075 — Checkout, Split Payment, and Sale Receipt UI
...
Standardize payment dialog, split methods, validation, sale completion, success state, receipt preview/print, and reset for next customer.
...
Write `agent_pack/reports/075_checkout_split_payment_receipt_flow_ui_REPORT.md` with:
