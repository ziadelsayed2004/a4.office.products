...
إدارة التصنيفات بدون صور إجبارية، وربطها بالمنتجات والريسيت والتقارير.
...
Write `agent_pack/reports/010_categories_module_REPORT.md` with all required report fields.
