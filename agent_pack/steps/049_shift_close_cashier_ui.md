...
# Step 049 — Shift Close Cashier UI
...
واجهة تقفيل الشيفت للكاشير بدون إظهار إيرادات عامة.
...
Write `agent_pack/reports/049_shift_close_cashier_ui_REPORT.md` with all required report fields.
