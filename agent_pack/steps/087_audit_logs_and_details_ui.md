# Step 087 — Audit Logs and Details UI
...
Implement filterable audit list, actor/action/entity/shift presentation, before/after detail dialog, mobile behavior, and large-payload readability.
...
Write `agent_pack/reports/087_audit_logs_and_details_ui_REPORT.md` with:
