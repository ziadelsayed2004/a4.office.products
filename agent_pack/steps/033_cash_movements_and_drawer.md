...
# Step 033 — Cash Movements And Drawer
...
حركات نقدية اختيارية: opening cash، cash in/out، مصروفات ورديات إن لزم.
...
Write `agent_pack/reports/033_cash_movements_and_drawer_REPORT.md` with all required report fields.
