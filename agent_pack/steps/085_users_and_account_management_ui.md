# Step 085 — Users and Account Management UI
...
Implement admin user list and account actions, create/edit/disable/reset-password flows, role/status presentation, responsive drawers, and strict RBAC visibility.
...
Write `agent_pack/reports/085_users_and_account_management_ui_REPORT.md` with:
