...
واجهة اختيار منتج وعدد ملصقات الـ QR والطابعة والمقاس والمعاينة.
...
Write `agent_pack/reports/045_product_qr_print_ui_REPORT.md` with all required report fields.
