# Step 084 — Reports, KPIs, Exports, and Charts UI
...
Standardize report tabs, filters, KPI summaries, tables/charts, current-filter export, mobile behavior, and theme-safe chart colors.
...
Write `agent_pack/reports/084_reports_kpis_exports_and_charts_ui_REPORT.md` with:
