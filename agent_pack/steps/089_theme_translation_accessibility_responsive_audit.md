# Step 089 — Theme, Translation, Accessibility, and Responsive Audit
...
Audit every route for light/dark parity, Arabic completeness, English key parity, RTL/LTR correctness, keyboard/scanner access, focus, touch targets, and all required viewports.
...
Primary focus: `agent_pack/docs/I18N_DIRECTION_RULES.md`.
...
Write `agent_pack/reports/089_theme_translation_accessibility_responsive_audit_REPORT.md` with:
