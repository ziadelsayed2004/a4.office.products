...
# Step 023 — Preorder Create Deposit
...
إنشاء حجز مسبق عندما المنتج غير متاح أو حسب إعداد المنتج، مع ديبوزت ونسبة مئوية.
...
Write `agent_pack/reports/023_preorder_create_deposit_REPORT.md` with all required report fields.
