...
# Step 037 — Backend API Postman Docs
...
توثيق API وخريطة Postman Collection مرتبة حسب admin/cashier/POS/reservation.
...
Write `agent_pack/reports/037_backend_api_postman_docs_REPORT.md` with all required report fields.
