...
اختبار product QR، reservation QR، print templates، reprint audit.
...
Write `agent_pack/reports/057_printing_qr_final_qa_REPORT.md` with all required report fields.
