...
مرتجعات و Refunds مع تأثير على المخزون والشيفت والـ audit.
...
Write `agent_pack/reports/034_returns_refunds_core_REPORT.md` with all required report fields.
