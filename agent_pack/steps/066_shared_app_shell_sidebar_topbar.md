# Step 066 — Shared App Shell, Sidebar, and Top Bar
...
Implement the template-matching desktop right sidebar, mobile right drawer, A4 identity header, account/role/shift cards, grouped navigation, theme/language controls, and logout.
...
Primary focus: `agent_pack/docs/UI_DESIGN_SYSTEM.md`.
...
Write `agent_pack/reports/066_shared_app_shell_sidebar_topbar_REPORT.md` with:
