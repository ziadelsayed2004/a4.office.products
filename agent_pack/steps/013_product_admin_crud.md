...
إضافة/تعديل/تعطيل المنتجات، ربط التصنيف، الأسعار، قابلية الحجز، نسبة الديبوزت.
...
Write `agent_pack/reports/013_product_admin_crud_REPORT.md` with all required report fields.
