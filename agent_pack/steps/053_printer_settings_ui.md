...
إعدادات طابعة الريسيت وطابعة QR وقوالب الطباعة.
...
Write `agent_pack/reports/053_printer_settings_ui_REPORT.md` with all required report fields.
