...
# Step 015 — Inventory Ledger Core
...
دفتر مخزون لا يسمح بالنزول تحت صفر، ويستوعب شراء/بيع/تسوية/تلف/استلام حجز.
...
Write `agent_pack/reports/015_inventory_ledger_core_REPORT.md` with all required report fields.
