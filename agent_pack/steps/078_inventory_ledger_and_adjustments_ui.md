# Step 078 — Inventory Ledger and Adjustments UI
...
Implement stock overview, open-preorder counters, low-stock states, adjustment drawer with reasons, ledger history, and no-negative-stock feedback.
...
Write `agent_pack/reports/078_inventory_ledger_and_adjustments_ui_REPORT.md` with:
