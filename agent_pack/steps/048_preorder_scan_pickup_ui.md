...
# Step 048 — Preorder Scan Pickup UI
...
واجهة سكان الـ QR الخاص بالحجز و Dialog الاستلام ودفع المتبقي.
...
Write `agent_pack/reports/048_preorder_scan_pickup_ui_REPORT.md` with all required report fields.
