...
واجهة تسجيل الدخول وإدارة الجلسة ورسائل الأخطاء.
...
Write `agent_pack/reports/040_login_and_session_ui_REPORT.md` with all required report fields.
