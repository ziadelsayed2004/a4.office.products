...
# Step 022 — Thermal Receipt Templates
...
قوالب طباعة حرارية للبيع العادي والحجز والاستلام النهائي.
...
Write `agent_pack/reports/022_thermal_receipt_templates_REPORT.md` with all required report fields.
