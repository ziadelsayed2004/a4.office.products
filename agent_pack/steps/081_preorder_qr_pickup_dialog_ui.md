# Step 081 — Preorder QR Pickup Dialog UI
...
Implement scan/search pickup dialog with customer, deposit, remaining amount, per-item stock state, payment, confirmation, final receipt, and mobile full-screen behavior.
...
Write `agent_pack/reports/081_preorder_qr_pickup_dialog_ui_REPORT.md` with:
