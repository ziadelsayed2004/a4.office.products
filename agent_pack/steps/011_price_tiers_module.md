...
إدارة فئات السعر من الأدمن: قطاعي، جملة، خاص، مدارس/مدرسين، موزعين، إلخ.
...
Write `agent_pack/reports/011_price_tiers_module_REPORT.md` with all required report fields.
