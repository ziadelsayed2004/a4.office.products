# Step 065 — I18N Arabic/English and Direction Foundation
...
Move shared shell strings into locale files, add matching Arabic/English keys, implement locale state, HTML lang/dir, MUI/Emotion direction switching, and technical-value isolation.
...
Write `agent_pack/reports/065_i18n_arabic_english_direction_foundation_REPORT.md` with:
