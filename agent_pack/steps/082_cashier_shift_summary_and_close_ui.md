# Step 082 — Cashier Shift Summary and Close UI
...
Implement own-shift dashboard, payment-method totals, cash movements, expected/actual inputs, difference validation, and close request.
...
Write `agent_pack/reports/082_cashier_shift_summary_and_close_ui_REPORT.md` with:
