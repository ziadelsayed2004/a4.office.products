...
# Step 007 — RBAC Permissions Matrix
...
تنفيذ صلاحيات admin/cashier وتقييد الكاشير من الإدارة والإيرادات العامة وتعديل حسابه.
...
Write `agent_pack/reports/007_rbac_permissions_matrix_REPORT.md` with all required report fields.
