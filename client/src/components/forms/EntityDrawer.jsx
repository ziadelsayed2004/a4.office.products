...
export function EntityDrawer({ open, title, subtitle, children, onClose, onSubmit, submitLabel = 'حفظ', loading = false, wide = false }) {
  return <Drawer className="entity-drawer" anchor="left" open={open} onClose={loading ? undefined : onClose} PaperProps={wide ? { sx: { width: 'min(820px, 100vw) !important' } } : undefined}>
